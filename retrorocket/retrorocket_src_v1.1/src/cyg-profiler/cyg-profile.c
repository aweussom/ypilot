    ...
    if (logfile || openlogfile(cyg_profile_filename))
      {
        ...
        if (((above_contents >> 24) & 0xff) == 0xff)
          {
            //err...
            panic("perf exit looks like an error\n");
            *(int *)0 = 0;
            while(1);
          }
        else
...
void cygprofile_begin(void)
{
  ...
  if (perfdata == NULL)
    {
      panic("couldn\'t allocate perf data\n");
      *(int *)0 = 0;
      while(1);
    }
...
///////////////////////////////////////////////////////////////////////////////
// RetroRocket additional functions

void
cygprofile_hblank(void)
{
  hblanks++;
}
